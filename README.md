...
<p align="center">
  <img src="assets/readme/applet-qrcode.jpg" alt="小白工具箱小程序二维码" width="220">
</p>
...
- 🖼️ **图片与视频处理** - 支持二维码生成、图片压缩、图片尺寸调整、长图拼接、九宫格切图、图片转 MARD 色号拼豆图纸和视频压缩。
...
| 运动健康 | BMI 计算、基础代谢率 |
| 理财计算 | 复利 / 定投计算器 |
| 生活娱乐 | 星座计算器、选择困难助手、电子木鱼 |
| 图片处理 | 二维码生成、图片压缩、图片尺寸调整、图片水印、长图拼接、九宫格切图、图片转 MARD 色号拼豆图纸 |
| 视频处理 | 视频压缩 |
| 棋牌工具 | 打牌记账 |
| 使用指南 | 小白工具箱使用指南 |
| 外部入口 | 电子社保卡、智形健身助手、12333、国家政务服务平台、Sky星尘 |
